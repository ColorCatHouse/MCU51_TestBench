...
#define		LCD_MODE_INPUT_DEC					0
#define		LCD_MODE_INPUT_SHIFT_ON				0x01
#define		LCD_MODE_INPUT_SHIFT_OFF  		 	0

#define		LCD_MODE_DISPLAY_ON					0x04
#define		LCD_MODE_DISPLAY_OFF				0
#define		LCD_MODE_DISPLAY_CURSOR_ON			0x02
#define		LCD_MODE_DISPLAY_CURSOR_OFF			0
#define		LCD_MODE_DISPLAY_CURSOR_BLINK_ON	0x01
#define		LCD_MODE_DISPLAY_CURSOR_BLINK_OFF	0

#define		LCD_MODE_SHIFT_MSG					1
#define		LCD_MODE_SHIFT_CURSOR			   	0
#define		LCD_MODE_SHIFT_RIGHT			   	1
#define		LCD_MODE_SHIFT_LEFT				   	0

#define		LCD_MODE_FUNCTION_DL8				0x10
#define		LCD_MODE_FUNCTION_DL4				0
#define		LCD_MODE_FUNCTION_2LINES			0x08
#define		LCD_MODE_FUNCTION_1LINE				0
#define		LCD_MODE_FUNCTION_FONT5X10			0x04
#define		LCD_MODE_FUNCTION_FONT5X7			0
...
/*********************************************************
 ...
 Set 8-bit Mode, 2 Lines, Font: 5x7
 *********************************************************/
void lcdInit(void);
